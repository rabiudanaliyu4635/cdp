				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-3 fixed-top">
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
							...
							<li class="nav-item">
								<a class="nav-link navbtn" href="volunteers.php">&nbsp Donor &nbsp </a>
							</li>
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item dbtn" href="profile.php">User Profile (<?php $uname = $_SESSION['fullname']; $sql2 = "SELECT * FROM useraccounts"; $result = mysqli_query($conn,$sql2); mysqli_free_result($result); echo $uname; ?>)<span class="sr-only">(current)</a>
